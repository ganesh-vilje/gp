...
| T-016 | M1 | done | build/M1 | PENDING_COMMIT | CI workflow at .github/workflows/ci.yml; pip-audit 0 vulns, unit 168 passed, middleware-ordering 14 passed, integration 98 passed (4x clean rerun), ruff/mypy clean; PR #1 opened, green run pending final push | code-reviewer, security-reviewer (2 rounds) |
